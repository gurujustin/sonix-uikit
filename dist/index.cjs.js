...
var Icon$v = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 90 90" }, props),
        React__default['default'].createElement("image", { width: 90, height: 90, href: "/images/3.png" })));
};
...
var SpinnerIcon = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 96 96" }, props),
        React__default['default'].createElement("image", { width: "96", height: "96", href: "/images/3.png" })));
};
...
var Logo$1 = function (_a) {
    ...
    return (React__default['default'].createElement(Flex, null,
        ...
        isAbsoluteUrl ? (React__default['default'].createElement(StyledLink$1, { as: "a", href: href, "aria-label": "Sonixswap home page" }, innerLogo)) : (React__default['default'].createElement(StyledLink$1, { to: href, "aria-label": "Sonixswap home page" }, innerLogo))));
};
...
var links = [
    ...
    },
    {
        ...
        items: [
            ...
            {
                label: "Docs",
                href: "https://app.gitbook.com/@anoswap/s/anonymousswap-finance/",
            },
            {
                label: "Blog",
...
var socials = [
    {
        ...
        items: [
            {
                label: "English",
                href: "https://t.me/sonixSWAPtoken",
            },
        ],
    },
    {
        label: "Twitter",
        icon: "TwitterIcon",
        href: "https://twitter.com/sonixswap",
    },
];
var MENU_HEIGHT = 64;
...
var PanelFooter = function (_a) {
    var isPushed = _a.isPushed, pushNav = _a.pushNav, toggleTheme = _a.toggleTheme, isDark = _a.isDark, kiwiPriceUsd = _a.kiwiPriceUsd, currentLang = _a.currentLang, langs = _a.langs, setLang = _a.setLang, priceLink = _a.priceLink;
    if (!isPushed) {
    ...
    return (React__default['default'].createElement(Container$4, null,
        React__default['default'].createElement(SocialEntry, null,
            kiwiPriceUsd ? (React__default['default'].createElement(PriceLink, { href: priceLink, target: "_blank" },
...
var Menu = function (_a) {
    var _b;
    var account = _a.account, login = _a.login, logout = _a.logout, isDark = _a.isDark, toggleTheme = _a.toggleTheme, langs = _a.langs, setLang = _a.setLang, currentLang = _a.currentLang, kiwiPriceUsd = _a.kiwiPriceUsd, links = _a.links, priceLink = _a.priceLink, profile = _a.profile, children = _a.children;
    ...
    return (React__default['default'].createElement(Wrapper$1, null,
        ...
        React__default['default'].createElement(BodyWrapper, null,
            React__default['default'].createElement(Panel, { isPushed: isPushed, isMobile: isMobile, showMenu: showMenu, isDark: isDark, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, kiwiPriceUsd: kiwiPriceUsd, pushNav: setIsPushed, links: links, priceLink: priceLink }),
